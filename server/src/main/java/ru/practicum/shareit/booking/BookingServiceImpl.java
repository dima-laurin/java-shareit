...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingDto create(Long userId, BookingRequestDto bookingDto) {
        ...
        ru.practicum.shareit.booking.Booking savedBooking = bookingRepository.save(booking);
    ...
    public BookingDto approve(Long userId, Long bookingId, Boolean approved) {
        ...
        ru.practicum.shareit.booking.Booking booking = getBookingOrThrow(bookingId);
        ...
        if (booking.getStatus() != ru.practicum.shareit.booking.BookingStatus.WAITING) {
        ...
        booking.setStatus(approved
                ...
                : ru.practicum.shareit.booking.BookingStatus.REJECTED);

        ru.practicum.shareit.booking.Booking updatedBooking = bookingRepository.save(booking);
    ...
    public Collection<BookingDto> getUserBookings(Long userId, String stateValue) {
        ...
        ru.practicum.shareit.booking.BookingState state = getBookingState(stateValue);
        LocalDateTime now = LocalDateTime.now();

        List<ru.practicum.shareit.booking.Booking> bookings;
    ...
    private ru.practicum.shareit.booking.BookingState getBookingState(String stateValue) {
        if (stateValue == null || stateValue.isBlank()) {
            return ru.practicum.shareit.booking.BookingState.ALL;
        }
